...
class DesaModel extends Model
{
    ...
    protected $allowedFields    = ['the_geom', 'ds', 'kec', 'kab', 'image'];
    ...
    public $column_order  = array(null, null, 'a.ds', 'a.kec', 'a.kab');
    public $column_search = array('a.ds', 'a.kec', 'a.kab');
    public $order         = array('a.ds' => 'asc');
    ...
    {
        $this->dt->select('a.id_desa, a.ds, a.kec, a.kab');
