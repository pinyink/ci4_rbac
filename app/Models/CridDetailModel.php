...
class CridDetailModel extends Model
{
    protected $DBGroup          = 'default';
    protected $table            = 'crid_detail';
    ...
    public $column_order  = array(null, null, 'a.name_field', 'a.name_alias', 'a.name_type');
    public $column_search = array('a.name_field', 'a.name_alias', 'a.name_type');
    public $order         = array('a.id' => 'asc');
    ...
    {
        $this->dt->select('a.id, a.crid_id, a.name_field, a.name_alias, a.name_type');
