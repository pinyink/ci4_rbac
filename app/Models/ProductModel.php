...
class ProductModel extends Model
{
    ...
    protected $allowedFields    = ['nama', 'harga', 'tanggal', 'deskripsi', 'foto', 'dokumen', 'categories_id'];
	...
	public function detail($where = [])
    {
        ...
        $table->select('a.nama, a.harga, a.tanggal, a.deskripsi, a.foto, a.dokumen, a.categories_id');
        $table->where($where);
        return $table->get();
    }
}