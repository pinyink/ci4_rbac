...
class PolicyModel extends Model
{
    ...
    protected $allowedFields    = ['policy_id', 'policy_desc'];
    ...
    public $column_order  = array(null, null, 'a.policy_id', 'a.policy_desc');
    public $column_search = array('a.policy_id', 'a.policy_desc');
    public $order         = array('a.policy_desc' => 'asc');
    ...
    {
        $this->dt->select('a.policy_id, a.policy_id, a.policy_desc');
