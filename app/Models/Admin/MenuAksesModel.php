...
class MenuAksesModel extends Model
{
    ...
    public $column_order  = array(null, null, 'a.menu_akses_id', 'a.menu_akses_desc', 'a.menu_id');
    public $column_search = array('a.menu_akses_id', 'a.menu_akses_desc', 'a.menu_id');
    public $order         = array('a.menu_id' => 'asc');
    ...
    {
        $this->dt->select('a.akses_id, a.menu_akses_id, a.menu_akses_desc, a.menu_id');
