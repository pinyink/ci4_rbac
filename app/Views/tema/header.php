        ...
        <ul class="nav navbar-toolbar">
                    ...
                    <li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f">
                        <div>
                            <a class="list-group-item">
                                <div class="media">
                                    <div class="media-img">
                                        <img src="<?= base_url(); ?>/assets/admincast/dist/assets/img/users/u1.jpg" />
                                    </div>
                            ...
                            <a class="list-group-item">
                                <div class="media">
                                    <div class="media-img">
                                        <img src="<?= base_url(); ?>/assets/admincast/dist/assets/img/users/u2.jpg" />
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="list-group-item">
                                <div class="media">
                                    <div class="media-img">
                                        <img src="<?= base_url(); ?>/assets/admincast/dist/assets/img/users/u3.jpg" />
                                    </div>
                                    <div class="media-body">
                            ...
                            <a class="list-group-item">
                                <div class="media">
                                    <div class="media-img">
                                        <img src="<?= base_url(); ?>/assets/admincast/dist/assets/img/users/u4.jpg" />
                                    </div>
                                    <div class="media-body">
            ...
            <li class="dropdown dropdown-user">
                <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                    ...
                    <span></span><?= session('fullname'); ?><i class="fa fa-angle-down m-l-5"></i></a>
